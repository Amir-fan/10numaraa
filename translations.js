...
const translations = {
    tr: {
        ...
        welcome_message: "Başarı her zaman büyüklükle ilgili değildir. Tutarlılıkla ilgilidir. Kaliteli üretim ve sürekli gelişim başarıyı getirir.",
        ...
        market_bag: "Market Poşeti",
        market_bag_desc: "Yüksek kaliteli, dayanıklı market poşetleri",
        custom_bag: "Özel Tasarım Poşet",
        custom_bag_desc: "Markanıza özel tasarlanmış poşetler",
        corporate_bag: "Kurumsal Poşet",
    ...
    en: {
        ...
        welcome_message: "Success is not always about size. It's about consistency. Quality production and continuous improvement bring success.",
        ...
        market_bag: "Market Bag",
        market_bag_desc: "High-quality, durable market bags",
        custom_bag: "Custom Design Bag",
        custom_bag_desc: "Bags specially designed for your brand",
        corporate_bag: "Corporate Bag",
    ...
    ar: {
        ...
        welcome_message: "النجاح ليس دائماً متعلقاً بالحجم. إنه متعلق بالثبات. الإنتاج عالي الجودة والتحسين المستمر يجلب النجاح.",
        ...
        market_bag: "كيس السوق",
        market_bag_desc: "أكياس سوق عالية الجودة ومتينة",
        custom_bag: "كيس تصميم مخصص",
        custom_bag_desc: "أكياس مصممة خصيصاً لعلامتك التجارية",
        corporate_bag: "كيس الشركة",
